module.exports = (Workout, power) => {
    ...
    warmUp.bike["WU: 10' TO 15', THEN 3 X 1' (1') @ ZONE 4, TO OPEN UP YOUR LEGS"] = new Workout(
        `<Warmup Duration='900' PowerLow='${power.bikeZone0}' PowerHigh='${power.bikeZone3}'/>\n
        <IntervalsT Repeat='3' OnDuration='60' OffDuration='60' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>`,
        21 * 60)
    ...
    warmUp.bike["WU: 10' TO 15' EASY, 3 X 1' (1') @ 95-100%/ZONE4/HARD.MS: 2 X 8' (2') @ 95-100%/ZONE4/HARD"] = new Workout(
        `<Warmup Duration='900' PowerLow='${power.bikeZone0}' PowerHigh='${power.bikeZone3}'/>\n
        <IntervalsT Repeat='3' OnDuration='60' OffDuration='60' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>\n
        <IntervalsT Repeat='2' OnDuration='480' OffDuration='120' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>`,
        41 * 60)

    warmUp.bike["WU: 15' TO 20' @ 60-65%/ZONE1/EASY"] = new Workout(
    ...
    warmUp.bike["WARM UP: 30' OF EASY TO STEADY SPINNING"] = new Workout(
        `<Warmup Duration='1800' PowerLow='${power.bikeZone1}' PowerHigh='${power.bikeZone2}'/>`,
        30 * 60)

    warmUp.bike["WARM UP: 60' OF EASY TO STEADY SPINNING"] = new Workout(
        `<Warmup Duration='3600' PowerLow='${power.bikeZone1}' PowerHigh='${power.bikeZone2}'/>`,
        60 * 60)

    warmUp.bike["WU: 10' EASY, THEN 8' BUILDING FROM 50% ESTIMATED FTP TO 100% ESTIMATED FTP IN 2' INCREMENTS, 2' EASY"] = new Workout(
    ...
    warmUp.bike["WU: 10 TO 15' OF SPINNING IN ZONES 1 AND 2"] = new Workout(
    ...
    warmUp.bike["WARM UP 20' IN ZONES 1 TO 2"] = new Workout(
        `<Warmup Duration='1200' PowerLow='${power.bikeZone1}' PowerHigh='${power.bikeZone2}'/>`,
        20 * 60)

    warmUp.bike["WARM UP FOR ALL ABILITIES: 20' TO 30' @ ZONE 1 TO ZONE 2"] = new Workout(
        `<Warmup Duration='1800' PowerLow='${power.bikeZone1}' PowerHigh='${power.bikeZone2}'/>`,
        30 * 60)
    ...
    warmUp.run["WU: 15' ZONE 1, 6 X 30'' STRIDES"] = new Workout(
        `<Warmup Duration='${power.gdt(900, [power.runZone1, power.runZone2])}' PowerLow='${power.runZone1}' PowerHigh='${power.runZone2}' pace='3' />\n
