...
export default (testDistance, testTime) => {
    ...
    bike["RACE REHEARSAL BRICK SET UP TRANSITION AT CAR/HOUSE, IF POSSIBLE"] = Workout(
        `<SteadyState Duration='900' Power='${power.bikeZone3}'/>\n
        <SteadyState Duration='2700' Power='${power.bikeZone4}'/>`,
        60 * 60)

    bike["SPEND AS MUCH TIME @ ZONE 3 AS POSSIBLE"] = Workout("", 0, power.bikeZone3)
    bike["REMAINDER OF AVAILABLE RIDE TIME AT ZONE 3"] = Workout("", 0, power.bikeZone3)
    bike["REMAINDER OF RIDE TIME IS @ZONE 2"] = Workout("", 0, power.bikeZone2)

    bike["BIKE TEST, FOR POWER ATHLETES ONLY!"] = Workout(
    ...
    bike["2 X (2' @ ZONE 5, THEN 1' @ ZONE 2, THEN 5' @ 95-100%/ZONE 4, THEN 10' @ ZONE 2)"] = Workout(
        ...
        <SteadyState Duration='120' Power='${power.bikeZone5}'/>\n
            ...
            <SteadyState Duration='600' Power='${power.bikeZone2}'/>`,
        36 * 60)
    bike["3 X (2' @ ZONE 5, THEN 1' @ ZONE 2, THEN 5' @ 95-100%/ZONE 4, THEN 10' @ ZONE 2)"] = Workout(
        `<SteadyState Duration='120' Power='${power.bikeZone5}'/>\n
            <SteadyState Duration='60' Power='${power.bikeZone2}'/>\n
            <SteadyState Duration='300' Power='${power.bikeZone4}'/>\n
            <SteadyState Duration='600' Power='${power.bikeZone2}'/>\n
    ...
    bike["4 X (2' @ ZONE 5, THEN 1' @ ZONE 2, THEN 5' @ 95-100%/ZONE 4, THEN 10' @ ZONE 2)"] = Workout(
        `<SteadyState Duration='120' Power='${power.bikeZone5}'/>\n
            <SteadyState Duration='60' Power='${power.bikeZone2}'/>\n
            <SteadyState Duration='300' Power='${power.bikeZone4}'/>\n
            <SteadyState Duration='600' Power='${power.bikeZone2}'/>\n
    ...
    bike["4 X (2' @ ZONE 5, THEN 1' @ ZONE 2, THEN 5' @ 95-100%/ZONE 4, THEN 5' @ ZONE 2)"] = Workout(
        `<SteadyState Duration='120' Power='${power.bikeZone5}'/>\n
            <SteadyState Duration='60' Power='${power.bikeZone2}'/>\n
            <SteadyState Duration='300' Power='${power.bikeZone4}'/>\n
        ...
        <SteadyState Duration='120' Power='${power.bikeZone5}'/>\n
            ...
            <SteadyState Duration='300' Power='${power.bikeZone2}'/>`,
        52 * 60)
    bike["5 X (2' @ ZONE 5, THEN 1' @ ZONE 2, THEN 5' @ ZONE 4, THEN 5' @ ZONE 2)"] = Workout(
        `<SteadyState Duration='120' Power='${power.bikeZone5}'/>\n
            <SteadyState Duration='60' Power='${power.bikeZone2}'/>\n
            <SteadyState Duration='300' Power='${power.bikeZone4}'/>\n
            <SteadyState Duration='300' Power='${power.bikeZone2}'/>\n
        ...
        <SteadyState Duration='120' Power='${power.bikeZone5}'/>\n
            ...
            <SteadyState Duration='300' Power='${power.bikeZone2}'/>`,
        65 * 60)
    bike["5 X (2' @ ZONE 5, THEN 1' @ ZONE 2, THEN 5' @ 95-100%/ZONE 4, THEN 10' @ ZONE 2)"] = Workout(
        `<SteadyState Duration='120' Power='${power.bikeZone5}'/>\n
            <SteadyState Duration='60' Power='${power.bikeZone2}'/>\n
            <SteadyState Duration='300' Power='${power.bikeZone4}'/>\n
            <SteadyState Duration='600' Power='${power.bikeZone2}'/>\n
        ...
        <SteadyState Duration='120' Power='${power.bikeZone5}'/>\n
            ...
            <SteadyState Duration='600' Power='${power.bikeZone2}'/>`,
        90 * 60)
    bike["6 X (2' @ ZONE 5, THEN 1' @ ZONE 2, THEN 5' @ 95-100%/ZONE 4, THEN 5' @ ZONE 2)"] = Workout(
        `<SteadyState Duration='120' Power='${power.bikeZone5}'/>\n
            <SteadyState Duration='60' Power='${power.bikeZone2}'/>\n
            <SteadyState Duration='300' Power='${power.bikeZone4}'/>\n
            <SteadyState Duration='300' Power='${power.bikeZone2}'/>\n
    ...
    bike["2 X 10' (4') @ 95-100%/ZONE4/HARD"] = Workout(
    ...
    bike["2 X 10' (4') @ 95-100%/ZONE4/HARD REMAINDER @ 75-80%/ZONE2/STEADY"] = Workout(
        `<IntervalsT Repeat='2' OnDuration='600' OffDuration='240' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>`,
        32 * 60, power.bikeZone2)
    bike["2 X 10' (3') @ 95-100%/ZONE4/HARD"] = Workout(
        `<IntervalsT Repeat='2' OnDuration='600' OffDuration='180' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>`,
        26 * 60)
    bike["2 X 10' (3') @ 95-100%/ZONE4/HARD REMAINDER OF TIME AT 80-85%/ZONE3/MOD-HARD"] = Workout(
        `<IntervalsT Repeat='2' OnDuration='600' OffDuration='180' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>`,
        26 * 60, power.bikeZone3)
    bike["2 X 12 (4') @ 95-100%/ZONE4/HARD"] = Workout(
    ...
    bike["2 X 12' (4') @ 95-100%/ZONE4/HARD REMAINDER OF TIME AT 80-85%/ZONE3/MOD-HARD"] = Workout(
        `<IntervalsT Repeat='2' OnDuration='720' OffDuration='240' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>`,
        32 * 60, power.bikeZone3)
    bike["THEN 2 X 15' (2') @ 80-85%/ZONE3/MOD-HARD"] = Workout(
        `<IntervalsT Repeat='2' OnDuration='900' OffDuration='120' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>`,
        20 * 60)
    bike["2 X 15' (4') @ 95-100%/ZONE4/HARD"] = Workout(
    ...
    bike["3 X 8' (4') @ ZONE 4"] = Workout(
        `<IntervalsT Repeat='3' OnDuration='480' OffDuration='240' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>`,
        36 * 60)
    bike["3 X 10' (4') @ ZONE 4"] = Workout(
    ...
    bike["3 X 10' (5') ALL @ ZONE 4, REMAINDER IN ZONE 2"] = Workout(
        `<IntervalsT Repeat='3' OnDuration='600' OffDuration='300' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>`,
        45 * 60, power.bikeZone2)
    bike["3 X 12' (4') @ 95-100%/ZONE4/HARD"] = Workout(
        `<IntervalsT Repeat='3' OnDuration='720' OffDuration='240' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>`,
        48 * 60)
    bike["3 X 12' (5') ALL @ ZONE 4, REMAINDER IN ZONE 2"] = Workout(
        `<IntervalsT Repeat='3' OnDuration='600' OffDuration='300' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>`,
        51 * 60, power.bikeZone2)
    bike["3 X 14' (6') ALL @ ZONE 4, REMAINDER IN ZONE 2"] = Workout(
        `<IntervalsT Repeat='3' OnDuration='600' OffDuration='300' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>`,
        60 * 60, power.bikeZone2)
    bike["3 X 20' (5') @ ZONE 2 TO ZONE 3 AS YOU FEEL"] = Workout(
    ...
    bike["12' (4'), 15' (5'), 18' (6') ALL @ ZONE 4, REMAINDER IN ZONE 2"] = Workout(
    ...
    bike["15' @ 80-85%/ZONE3/MOD-HARD 45' @ 95-100%/ZONE4/HARD FAST TRANSITION STRAIGHT TO RUN"] = Workout(
            `<SteadyState Duration='900' Power='${power.bikeZone3}'/>\n
            <SteadyState Duration='2700' Power='${power.bikeZone4}'/>`,
        20 * 60)

    bike["THEN RIDE STEADY IN ZONE 1 TO ZONE 2 FOR 140'"] = Workout(
        `<Warmup Duration='8400' PowerLow='${power.bikeZone1}' PowerHigh='${power.bikeZone2}'/>`,
        140 * 60)

    bike["MS: 1' ''ON'' @ 120%/ZONE5/VERY HARD, 1' ''OFF'' @ 60-65%/ZONE1/EASY. REPEAT FOR A TOTAL OF 6' OF ''ON'' TIME"] = Workout(
        `<IntervalsT Repeat='6' OnDuration='60' OffDuration='60' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>`,
        12 * 60)
    bike["MS: 1' ''ON'' @ 120%/ZONE5/VERY HARD, 1' ''OFF'' @ 60-65%/ZONE1/EASY. REPEAT FOR A TOTAL OF 8' OF ''ON'' TIME"] = Workout(
        `<IntervalsT Repeat='8' OnDuration='60' OffDuration='60' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>`,
        16 * 60)
    bike["MS: 1' ''ON'' @ 120%/ZONE5/VERY HARD, 1' ''OFF'' @ 60-65%/ZONE1/EASY. REPEAT FOR A TOTAL OF 10' OF ''ON'' TIME"] = Workout(
        `<IntervalsT Repeat='10' OnDuration='60' OffDuration='60' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>`,
        20 * 60)
    bike["MS: 1' ''ON'' @ 120%/ZONE5/VERY HARD, 1' ''OFF'' @ 60-65%/ZONE1/EASY. REPEAT FOR A TOTAL OF 12' OF ''ON'' TIME"] = Workout(
        `<IntervalsT Repeat='12' OnDuration='60' OffDuration='60' OnPower='${power.bikeZone4}' OffPower='${power.bikeZone0}'/>`,
        24 * 60)
    bike["MS: 1' ''ON'' @ 120%/ZONE5/VERY HARD, 1' ''OFF'' @ 60-65%/ZONE1/EASY. REPEAT FOR A TOTAL OF 14' OF ''ON'' TIME"] = Workout(
    ...
    bike["RIDE NO MORE THAN 112 MILES OR 6 HOURS, WHICHEVER COMES FIRST"] = Workout(
